...
func expectedSchemaTables() map[string][]schemaColumn {
	return map[string][]schemaColumn{
		...
		"members": {
			...
			expectedColumn("icon_key", "TEXT", 1, 0), expectedColumn("note", "TEXT", 0, 0), expectedColumn("sort_order", "INTEGER", 1, 0, "0"),
			expectedColumn("created_at", "TEXT", 1, 0), expectedColumn("updated_at", "TEXT", 1, 0), expectedColumn("archived_at", "TEXT", 0, 0),
		},
		"institutions": {
			expectedColumn("id", "TEXT", 1, 1), expectedColumn("household_id", "TEXT", 1, 0), expectedColumn("name", "TEXT", 1, 0),
			expectedColumn("institution_type", "TEXT", 1, 0), expectedColumn("country_code", "TEXT", 0, 0), expectedColumn("website", "TEXT", 0, 0),
			expectedColumn("note", "TEXT", 0, 0), expectedColumn("sort_order", "INTEGER", 1, 0, "0"),
			expectedColumn("created_at", "TEXT", 1, 0), expectedColumn("updated_at", "TEXT", 1, 0), expectedColumn("archived_at", "TEXT", 0, 0), expectedColumn("icon_key", "TEXT", 1, 0),
		},
		"account_groups": {
			expectedColumn("id", "TEXT", 1, 1), expectedColumn("household_id", "TEXT", 1, 0), expectedColumn("name", "TEXT", 1, 0), expectedColumn("icon_key", "TEXT", 1, 0),
			expectedColumn("color", "TEXT", 0, 0), expectedColumn("description", "TEXT", 0, 0), expectedColumn("sort_order", "INTEGER", 1, 0, "0"),
			expectedColumn("created_at", "TEXT", 1, 0), expectedColumn("updated_at", "TEXT", 1, 0), expectedColumn("archived_at", "TEXT", 0, 0),
		},
		"accounts": {
			...
			expectedColumn("default_currency", "TEXT", 1, 0), expectedColumn("note", "TEXT", 0, 0),
