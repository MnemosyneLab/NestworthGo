...
const (
	...
	ErrBackupInvalidFormat         ErrorCode = "backup_invalid_format"
	ErrBackupMissingMember         ErrorCode = "backup_missing_member"
	ErrBackupChecksumFailed        ErrorCode = "backup_checksum_failed"
	ErrBackupSchemaUnsupported     ErrorCode = "backup_schema_unsupported"
	ErrBackupIntegrityFailed       ErrorCode = "backup_integrity_failed"
	ErrBackupBusinessInvariant     ErrorCode = "backup_business_invariant_failed"
	ErrBackupRestoreConfirmation   ErrorCode = "backup_restore_confirmation_required"
