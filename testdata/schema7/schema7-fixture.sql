...
CREATE TABLE accounts (
    ...
    group_id TEXT,
    name TEXT NOT NULL,
    account_type TEXT NOT NULL CHECK(account_type IN ('cash_on_hand','bank_account','brokerage','investment_account','crypto_exchange','digital_wallet','pension','insurance_policy','property','vehicle','collectible','receivable','credit_card','loan','other')),
    balance_sheet_role TEXT NOT NULL CHECK(balance_sheet_role IN ('asset','liability')),
    ...
    CHECK(
        ...
        (account_type = 'crypto_exchange' AND balance_sheet_role = 'asset' AND tracking_mode = 'holdings') OR
        (account_type = 'digital_wallet' AND balance_sheet_role = 'asset' AND tracking_mode IN ('balance','holdings')) OR
        (account_type = 'pension' AND balance_sheet_role = 'asset' AND tracking_mode IN ('holdings','manual_value')) OR
        (account_type = 'insurance_policy' AND balance_sheet_role = 'asset' AND tracking_mode = 'manual_value') OR
        (account_type = 'property' AND balance_sheet_role = 'asset' AND tracking_mode = 'manual_value') OR
        (account_type = 'vehicle' AND balance_sheet_role = 'asset' AND tracking_mode = 'manual_value') OR
        (account_type = 'collectible' AND balance_sheet_role = 'asset' AND tracking_mode = 'manual_value') OR
        (account_type = 'receivable' AND balance_sheet_role = 'asset' AND tracking_mode IN ('balance','manual_value')) OR
        (account_type = 'credit_card' AND balance_sheet_role = 'liability' AND tracking_mode = 'balance') OR
        (account_type = 'loan' AND balance_sheet_role = 'liability' AND tracking_mode = 'balance') OR
        (account_type = 'other' AND balance_sheet_role = 'asset' AND tracking_mode IN ('balance','manual_value','holdings')) OR
        (account_type = 'other' AND balance_sheet_role = 'liability' AND tracking_mode = 'balance')
    ),
    FOREIGN KEY(household_id) REFERENCES households(id) ON DELETE CASCADE,
...
CREATE TABLE history_origin_account_states (
    ...
    include_in_portfolio INTEGER NOT NULL CHECK(include_in_portfolio IN (0,1)),
...
INSERT INTO accounts(id, household_id, institution_id, group_id, name, account_type, balance_sheet_role, tracking_mode, default_currency, include_in_net_worth, include_in_portfolio, include_in_liquid_assets, created_at, updated_at, archived_at)
VALUES
('00000000-0000-4000-8000-000000000020', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000011', 'Family Cash', 'bank_account', 'asset', 'balance', 'CNY', 1, 0, 1, '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', NULL),
('00000000-0000-4000-8000-000000000021', '00000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000010', '00000000-0000-4000-8000-000000000011', 'Portfolio', 'brokerage', 'asset', 'holdings', 'USD', 1, 1, 0, '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', NULL),
('00000000-0000-4000-8000-000000000022', '00000000-0000-4000-8000-000000000001', NULL, NULL, 'Archived Account', 'cash_on_hand', 'asset', 'balance', 'CNY', 1, 0, 0, '2026-01-01T00:00:00.000Z', '2026-01-03T00:00:00.000Z', '2026-01-03T00:00:00.000Z'),
('00000000-0000-4000-8000-000000000023', '00000000-0000-4000-8000-000000000001', NULL, NULL, 'Manual Value', 'property', 'asset', 'manual_value', 'CNY', 1, 0, 0, '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', NULL);
...
('00000000-0000-4000-8000-000000000022', '00000000-0000-4000-8000-000000000002', 10000),
...
INSERT INTO accounts(id, household_id, name, account_type, balance_sheet_role, tracking_mode, default_currency, include_in_net_worth, include_in_portfolio, include_in_liquid_assets, created_at, updated_at, archived_at)
VALUES('00000000-0000-4000-8000-000000000024', '00000000-0000-4000-8000-000000000001', 'Transfer Portfolio', 'brokerage', 'asset', 'holdings', 'USD', 1, 1, 0, '2026-01-01T00:00:00.000Z', '2026-01-01T00:00:00.000Z', NULL);
INSERT INTO account_ownership(account_id, member_id, share_bps)
...
INSERT INTO history_origin_components(id, origin_id, component_kind, account_id, holding_id, instrument_id, quantity, unit_cost, created_at)
VALUES
('00000000-0000-4000-8000-000000000101', '00000000-0000-4000-8000-000000000100', 'holding_quantity', '00000000-0000-4000-8000-000000000021', '00000000-0000-4000-8000-000000000050', '00000000-0000-4000-8000-000000000040', '3', '720', '2026-01-02T00:00:00.000Z'),
('00000000-0000-4000-8000-000000000102', '00000000-0000-4000-8000-000000000100', 'holding_quantity', '00000000-0000-4000-8000-000000000021', '00000000-0000-4000-8000-000000000051', '00000000-0000-4000-8000-000000000041', '1000', '4.1', '2026-01-02T00:00:00.000Z');
INSERT INTO history_origin_components(id, origin_id, component_kind, account_id, holding_id, instrument_id, quantity, unit_cost, created_at)
VALUES('00000000-0000-4000-8000-000000000103', '00000000-0000-4000-8000-000000000100', 'holding_quantity', '00000000-0000-4000-8000-000000000024', '00000000-0000-4000-8000-000000000053', '00000000-0000-4000-8000-000000000040', '1', '720', '2026-01-02T00:00:00.000Z');
...
INSERT INTO history_origin_account_states(origin_id, account_id, archived_at, include_in_net_worth, include_in_portfolio, include_in_liquid_assets, created_at)
VALUES
...
VALUES
('00000000-0000-4000-8000-000000000130', '00000000-0000-4000-8000-000000000050', '3', '2026-01-02T00:00:00.000Z', '2026-01-02T00:00:00.000Z', NULL, 'baseline'),
