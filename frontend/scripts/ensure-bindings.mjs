...
const pinnedWailsVersion = "v3.0.0-beta.21";
...
if (checkOnly) {
	...
	if (result.status !== 0) {
		console.error("Failed to generate frontend/bindings. Install Wails v3.0.0-beta.21 and retry from the repository root:");
