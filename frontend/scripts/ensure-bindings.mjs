...
const pinnedWailsVersion = "v3.0.0-beta.23";
...
if (checkOnly) {
	...
	if (result.status !== 0) {
		console.error("Failed to generate frontend/bindings. Install Wails v3.0.0-beta.23 and retry from the repository root:");
