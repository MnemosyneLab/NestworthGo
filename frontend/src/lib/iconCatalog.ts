...
export const ICON_CATALOG: IconChoice[] = [
  ...
  { key: "user", labelKey: "icons.user", categoryKey: "icons.category.general" },
  { key: "landmark", labelKey: "icons.landmark", categoryKey: "icons.category.general" },
  { key: "car", labelKey: "icons.car", categoryKey: "icons.category.general" },
  { key: "gem", labelKey: "icons.gem", categoryKey: "icons.category.general" },
  { key: "pie-chart", labelKey: "icons.pieChart", categoryKey: "icons.category.general" },
