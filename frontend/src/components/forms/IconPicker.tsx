  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <details className="rounded-md border border-border bg-background">
        <summary id={id} aria-label={t("common.chooseIcon")} className="flex cursor-pointer list-none items-center gap-2 px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50">
