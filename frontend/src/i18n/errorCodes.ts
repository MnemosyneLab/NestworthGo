...
export const errorCodesEn: ErrorCodeCatalog = {
  ...
  database_upgrade_required: "This database was created by an older Nestworth version. Keep the file and restore through a supported path.",
...
export const errorCodesZhCN: ErrorCodeCatalog = {
  ...
  unavailable: "当前不可用。",
  database_upgrade_required: "此数据库由较旧版本的 Nestworth 创建。请保留该文件，并通过支持的路径恢复。",
...
export const errorCodesZhTW: ErrorCodeCatalog = {
  ...
  unavailable: "目前無法使用。",
  database_upgrade_required: "此資料庫由較舊版本的 Nestworth 建立。請保留該檔案，並透過支援的路徑還原。",
