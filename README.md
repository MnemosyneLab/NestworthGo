...
line is `0.3.2`: a Wails v3 desktop shell with a Go backend and a React +
TypeScript frontend.
...
`dist/macos/Nestworth-0.3.2-arm64.dmg`. Signing, notarization, artifact
retention, and manual accessibility review remain distribution gates.

## Technology

- Go 1.26 and Go modules;
- Wails v3 `v3.0.0-beta.19`;
