...
validation.
The [Wails version upgrade guide](wails-version-upgrade.md) covers synchronized
Wails module/runtime/CLI upgrades, bindings regeneration, automated checks, and
