...
```text
Go module:      github.com/wailsapp/wails/v3 v3.0.0-beta.23
Frontend:       @wailsio/runtime 3.0.0-beta.23
CLI/fallback:   v3.0.0-beta.23
```
...
```bash
WAILS_GO_VERSION=v3.0.0-beta.23
WAILS_RUNTIME_VERSION=3.0.0-beta.23
...
```text
chore(deps): upgrade Wails to v3.0.0-beta.23
```
