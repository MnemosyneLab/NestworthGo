...
**ACCEPTANCE MOSTLY MET (known PARTIALs D5/D6; C5–C9 SKIP; cold-3y)** — Round-2 blocker **DEF-R2-02 FIXED** (probe + desktop). Residual: incomplete-matrix desktop **PENDING**; probes **C5–C9 SKIP**; desktop **D5/D6 PARTIAL**; Linux **cold-3y** known.
