...
**Persistence correction (2026-08-24):** the shipped v0.1.4 generation uses
one complete schema 6 and rejects non-empty older databases without migration
or writes. The migration/backfill wording retained in the historical Phase 0
and Phase 2 notes below is superseded by this rule; current acceptance evidence
is tracked in [`product-quality-investigation-2026-08-24.zh-CN.md`](../development/product-quality-investigation-2026-08-24.zh-CN.md).
